...
interface PersonalLoadingScreenProps {
  onLoadingComplete: () => void;
  loadingTime?: number;
}

const PersonalLoadingScreen: React.FC<PersonalLoadingScreenProps> = ({
  onLoadingComplete,
  loadingTime = 2000
}) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-4">
        ...
        <p className="text-xl font-medium text-black">Personal</p>
      </div>
...
export default PersonalLoadingScreen;