...
const TransactionSection = () => {
  ...
  return (
    <div className="animate-fade-in px-4 lg:px-0" style={{animationDelay: "100ms"}}>
      ...
      <div className="bg-white rounded-xl shadow-sm border p-1 max-h-[280px] lg:max-h-[400px] overflow-y-auto">
