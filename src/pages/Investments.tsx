      ...
      <div className="container mx-auto max-w-md px-4 py-6">
        ...
        <div className="animate-fade-in" style={{ animationDelay: "150ms" }}>
          ...
          <div className="flex gap-6 mb-2">
            <button
              className={`text-base font-medium transition-colors pb-1 border-b-2 ${favType === "Stocks"
                ? "text-black border-finance-green"
                : "text-gray-400 border-transparent"} focus:outline-none`}
              onClick={() => setFavType("Stocks")}
              aria-selected={favType === "Stocks"}
            >
              Stocks
            </button>
            <button
              className={`text-base font-medium transition-colors pb-1 border-b-2 ${favType === "Crypto"
                ? "text-black border-finance-green"
                : "text-gray-400 border-transparent"} focus:outline-none`}
              onClick={() => setFavType("Crypto")}
              aria-selected={favType === "Crypto"}
            >
              Crypto
            </button>
          </div>
